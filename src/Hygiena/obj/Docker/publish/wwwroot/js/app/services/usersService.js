    ...
    function($http) {
        return {
            ...
            updateUserSettings: function (section, userSettings, fromDateUtc, toDateUtc) {
                var data = $.param({ whichSection: section, cus: userSettings, fromUtc: fromDateUtc, toUtc: toDateUtc });
