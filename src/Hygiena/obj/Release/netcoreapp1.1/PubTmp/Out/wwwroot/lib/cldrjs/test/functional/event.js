define([
    ...
    function(Cldr, util, likelySubtagsJson) {
        ...
        ["off", "on", "once"].forEach(function(method) {
            describe("Cldr." + method + "( event, listener )",
                function() {

                    it("should throw error on missing event parameter",
                        function() {
                            expect(function() {
                                Cldr[method]();
                    ...
                    it("should throw error on missing listener parameter",
                        function() {
                            expect(function() {
                                Cldr[method]("get");
                            }).to.throw(Error, /E_MISSING_PARAMETER/);
                    ...
                    it("should throw error on invalid event parameter type",
                        function() {
                            util.assertEventParameter(expect,
                    ...
                    it("should throw error on invalid listener parameter type",
                        function() {
                            util.assertFunctionParameter(expect,
                                function(invalidValue) {
                                    return function() {
        ...
        describe("Cldr.on( \"get\", listener )",
            function() {

                it("should add the listener to the global `get` event",
                    function(done) {
                        function listener() {
                            done();
                        }
                ...
                it("should pass path and value to the listener",
                    function(done) {
        ...
        describe("Cldr.off( \"get\", listener )",
            function() {

                it("should remove the specific listener from the global `get` event",
                    function(done) {
        ...
        describe("Cldr.once( \"get\", listener )",
            function() {

                it("should add the listener to the global `get` event *once*",
                    function(done) {
        ...
        describe("cldr.on( \"get\", listener )",
            function() {
                ...
                it("should add the listener to the instance `get` event",
                    function(done) {
                        var status = new Error("Did not listen");
        ...
        describe("cldr.off( \"get\", listener )",
            function() {
                ...
                it("should remove the specific listener from the instance `get` event",
                    function(done) {
                        var status = new Error("Also removed wrong listener `listener2`");
        ...
        describe("cldr.once( \"get\", listener )",
            function() {
                ...
                it("should add the listener to the instance `get` event *once*",
                    function(done) {
                        var status = new Error("Did not listen");
