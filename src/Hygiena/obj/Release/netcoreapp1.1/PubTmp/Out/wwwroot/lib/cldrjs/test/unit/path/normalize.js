    ...
    function(pathNormalize) {
        ...
        describe("Path Normalize",
            function() {
                ...
                it("should ignore a leading slash / on path",
                    function() {
                        var value = pathNormalize("/supplemental/likelySubtags");
                        expect(value).to.be.instanceof(Array);
                        expect(value).to.eql(["supplemental", "likelySubtags"]);
                ...
                it("should ignore a leading /cldr/ or cldr/ on path",
                    function() {
                ...
                it("should replace attribute variables",
                    function() {
                        expect(pathNormalize("main/{languageId}/numbers/decimalFormats-numberSystem-latn",
                                { languageId: "root" })).to
                            .eql(["main", "root", "numbers", "decimalFormats-numberSystem-latn"]);
                    });

                it("should split the inner Strings of an Array into a flatten Array",
                    function() {
                        expect(pathNormalize(["main/{languageId}/numbers", "decimalFormats-numberSystem-latn"],
                                { languageId: "root" })).to
                            .eql(["main", "root", "numbers", "decimalFormats-numberSystem-latn"]);
