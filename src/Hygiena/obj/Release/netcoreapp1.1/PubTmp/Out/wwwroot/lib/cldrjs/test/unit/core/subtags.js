    ...
    function(subtags) {
        ...
        describe("Subtags",
            function() {
                ...
                it("should match language_region",
                    function() {
                ...
                it("should match language_script",
                    function() {
                ...
                it("should match language_script_region",
                    function() {
