    ...
    function(Cldr, itemLookup, ptNumbersJson, genderJson, likelySubtagsJson) {
        ...
        describe("Item Lookup",
            function() {
                ...
                it("should get resolved items",
                    function() {
                        var cldr = new Cldr("root");
                        expect(itemLookup(Cldr, cldr.locale, "/supplemental/gender/personList/de", cldr.attributes)).to
                            .equal("neutral");
                    });

                it("should resolve and get unresolved items",
                    function() {
                        var cldr = new Cldr("pt_BR");
                        expect(itemLookup(Cldr,
                            cldr.locale,
                            "/main/{bundle}/numbers/symbols-numberSystem-latn/decimal",
                            cldr.attributes)).to.equal(",");
                    });

                it("should only cache found resolved items",
                    function() {
                        var cldr = new Cldr("root");
                ...
                it("should only cache leaf items",
                    function() {
                        var cldr = new Cldr("root");
