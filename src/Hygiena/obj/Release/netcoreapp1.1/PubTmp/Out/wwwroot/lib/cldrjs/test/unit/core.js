            ...
            function() {
                ...
                describe("Constructor",
                    function() {
                        ...
                        it("should normalize a locale on initialization",
                            function() {
                                cldr = new Cldr("pt-BR");
                        ...
                        it("should set unicode locale extensions attributes",
                            function() {
                        ...
                        it("should set minLanguageId and maxLanguageId attributes",
                            function() {
                                cldr = new Cldr("en");
                        ...
                        it("should implement cldr.main as an alias of get( \"main/{bundle}...\" )",
                            function() {
                                cldr = new Cldr("en");
