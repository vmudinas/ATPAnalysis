    ...
    function($scope,
        ...
        function init() {
            try {
                ...
                $scope.selectedLang = $rootScope.baseUrl;
                  ...
                  // Load report Screen for report generation
                //if (window.location.href.includes("Reports")) {
                //    $location.path("/reports");
                //}
              //  console.log(" $scope.selectedLang");
            //    console.log($scope.selectedLang);
                if ($scope.selectedLang != undefined) {
                    $scope.selectedLang = $scope.selectedLang.replace("Account/ForgotPassword", "")
                        .replace("Manage", "").replace("Reports", "")
        ...
        $scope.selectLanguage = function(flagUrl, languageSelected) {
            try {
                ...
                if (window.location.href.indexOf("Reports") === -1 && window.location.href.indexOf("Manage") === -1 && window.location.href.indexOf("Account") === -1) {
